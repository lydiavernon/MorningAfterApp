    ...
    <div className="stussy__wrap">
      ...
      <section className="stussy">
        <div className="wrapper">
          ...
          <article className="stussy__video">
            <img className="img" src={stussy2} alt="stussy image" />
            <p className="stussy__text">first video</p>
          </article>
          <article className="stussy__video">
            <img className="img" src={stussy3} alt="stussy image" />
          </article>

          <article className="stussy__video">
            <img className="img" src={stussy4} alt="stussy image" />
          </article>
          <article className="stussy__video">
            <video className="img" autoPlay muted loop src={stussy7}></video>
          </article>
          <article className="stussy__video">
            <img className="img" src={stussy5} alt="stussy image" />
          </article>

          <article className="stussy__video">
            <img className="img" src={stussy6} alt="stussy image" />
          </article>
        </div>
      </section>
    </div>
